...
public class Model implements Contract.Model, OnCompleteListener<AuthResult>, FirebaseAuth.AuthStateListener, com.pedromassango.programmers.presentation.signup.Contract.OnSignupListener {
    ...
    private void loginWithGoogleFlow(FirebaseUser user, Usuario mServerUsuario) {
        ...
        com.pedromassango.programmers.presentation.signup.Model sModel = new com.pedromassango.programmers.presentation.signup.Model(presenter);
